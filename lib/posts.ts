...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "p", text: "Paid ads can fill the gap while that compounds. Ads are not a substitute for the listing and the site. They are the fast lane. Pricing for a managed local program in the RGV generally sits in the same range we publish elsewhere: month-to-month plans from $397 to $2,499 depending on how many channels you are running, and the entry plans include the website itself. No honest shop guarantees #1. Anyone who does is selling you a penalty risk." },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "p", text: "Paid ads can fill the gap while that compounds. Ads are not a substitute for the listing and the site. They are the fast lane. People searching \"affordable seo marketing harlingen\" are usually trying to avoid a big-city retainer. Fair. Pricing for a managed local program in the RGV generally sits in the range we publish elsewhere: month-to-month plans from $397 to $2,499 depending on how many channels you are running, and the entry plans include the website itself. No honest shop guarantees #1. Anyone who does is selling you a penalty risk." },
