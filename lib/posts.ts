...
export const POSTS: Post[] = [
  {
    ...
    sections: [
      ...
      { type: "p", text: "At RGV Performance Marketing, plans are transparent and month-to-month — $397/mo for a website and lead system, up to $2,499/mo to fully own your local market — with no long-term contracts. You can see the full breakdown on our pricing page." },
